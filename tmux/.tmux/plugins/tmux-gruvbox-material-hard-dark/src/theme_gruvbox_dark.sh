...
theme_set_dark() {
  ...
  tmux_append_seto "status-left" "#[bg=${col_aqua},fg=${col_bg1}] ${_left_status_a} #[bg=${col_bg1},fg=${col_aqua},nobold,noitalics,nounderscore]"

  # right status
  local _status_right_bg=${col_bg1}
  if [[ "$_statusbar_alpha" == "true" ]]; then _status_right_bg="default"; fi
  tmux_append_seto "status-right" "#[bg=${_status_right_bg},fg=${col_fg3},nobold,noitalics,nounderscore]#[bg=${col_fg3},fg=${col_bg1}] ${_right_status_z}"
  ...
  tmux_append_setwo "window-status-current-format" "#[bg=${col_blue},fg=${col_bg1},nobold,noitalics,nounderscore]#[bg=${col_blue},fg=${col_bg2}] #I #[bg=${col_blue},fg=${col_bg2},bold] #W#{?window_zoomed_flag,*Z,} #{?window_end_flag,#[bg=${_current_window_status_format_bg}],#[bg=${col_bg1}]}#[fg=${col_blue},nobold,noitalics,nounderscore]"
